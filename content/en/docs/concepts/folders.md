...
| **NodeGroups**       | One or more groups of computation nodes |
...
Folders are fully isolated from each other. Nodes in one folder cannot reference nodes in another, and uploads to one folder do not affect another. This makes folders safe to use concurrently.
