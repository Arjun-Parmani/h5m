...
Quarkus also exposes a health check endpoint (if `quarkus-smallrye-health` is on the classpath):
...
These can be used as Kubernetes liveness and readiness probes.
